<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddStandard.aspx.cs" Inherits="OASys.FileManager.AddStandard" %>
...
<body>
    <form id="form1" runat="server">
      <div style="width:1046px; margin:auto;height:500px ">
			 <div  class="panel-header"  title="制度规范" style="padding-left:20px; ">
              <%=PageStaute%>制度规范
             <div style="width:50px; float:right"><a class="a1" title="返回列表" href="Standard.aspx">返回列表</a></div> 
			 </div>
             <table style="padding-right:10px; padding-left:18px; padding-top:10px;border-bottom:1px solid #ccc;border-left:1px solid #ccc;border-right:1px solid #ccc; width:100%; ">
              ...
              <tr>
                 ...
                 <td style=" width:50px"></td>
                  ...
                  <td>
                  <input id="txtUsName" readonly="true" runat="server" class="textbox03" style="width:800px"  /> 
                  </td>
                  <td style=" width:50px"></td>
                  </tr> 
                  ...
                  <td>
                  <asp:DropDownList ID="dplBusiness" runat="server" CssClass="textbox03" Width="806px"></asp:DropDownList>
                  </td>
                  <td style=" width:50px"></td>
                  </tr>
