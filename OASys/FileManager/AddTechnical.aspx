<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddTechnical.aspx.cs" Inherits="OASys.FileManager.AddTechnical" %>
...
<body style="overflow:hidden;" scroll="no">
    ...
    <div style="width:1046px; margin:auto;height:500px ">
			 <div  class="panel-header"  title="添加新知识" style="padding-left:20px; ">
              提交技术资料
             <div style="width:50px; float:right"><a class="a1" title="返回列表" href="Technical.aspx">返回列表</a></div> 
			 </div>
              <table style="padding-right:10px; padding-left:18px;border-bottom:1px solid #ccc;border-left:1px solid #ccc;border-right:1px solid #ccc; width:100%; ">
                   ...
                   <tr >
                      ...
                      <td >  
                          <input runat="server" id="txtTitle" class="textbox03" style="width:100%"/>   
                  ...
                  <tr >
                      ...
                      <td >
                         ...
                         <asp:Button ID="bthAddFile" runat="server" CssClass="button white" Text="提 交" OnClick="bthAddFile_Click1"  />
