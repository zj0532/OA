...
<body style="overflow:hidden;" scroll="no"  onload="Show()">
    ...
    <table id="dg" title="请假审核" style="width:1030px;height:460px"
...
<div id="hideDiv" style="display:none">
 ...
 <%--请假div begin--%>
    <div id="dlg" class="easyui-dialog" closed="true" title="请假申请详细信息" style="width:500px;height:360px;padding:50px; padding-top:30px">
        <table>
            <tr>
                <td style="width:60px">
                标题：
            ...
            <tr>
             ...
             <tr>
                ...
                <td>
                <input id="txtQJCount"  type="text" style=" width:150px" />天
                </td>
            </tr>
