...
<body style="overflow:hidden;" scroll="no" onload="Show()" > 
        ...
        function ExportFun()
        {
            ...
            $(function () {
                ...
                $.ajax({
                    ...
                    url: "../Ashx/User/UserInfoExportHandler.ashx",
   ...
   <div id="hideDiv" style="display:none">
    ...
    <!--弹出添加框 begin-->
    <div id="dlg" class="easyui-dialog" closed="true" title="添加新组员"  style="width:650px;height:450px;padding:10px;" >
       <table>
           <tr>
               <td width="20px">
   ...
   <!--弹出修改框 begin-->
        <div id="dlgUpdate" class="easyui-dialog" closed="true" title="修改组员信息"  style="width:650px;height:445px;padding:10px;" >
       <table>
           <tr>
               <td width="20px">
