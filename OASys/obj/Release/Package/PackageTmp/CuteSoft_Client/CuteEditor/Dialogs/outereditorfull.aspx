...
var OxOd44a=["postback","Save"];function doClose(){Window_SetDialogReturnValue(window,null);var OxOb4cd=[];Window_CloseDialog(window);} ;function CuteEditor_OnCommand(editor,Ox4d,Ox4e,Ox4f){if(Ox4d.toLowerCase()==OxOd44a[0]&&Ox4f==OxOd44a[1]){Window_SetDialogReturnValue(window,'<%= Request.QueryString["f"]%>');} ;} ;
</script>

<asp:Panel runat=server Visible=false id="savedpanel">
<script language="JavaScript" type="text/javascript" >
var OxOb4cd=[];Window_CloseDialog(window);
</script>
</asp:Panel>