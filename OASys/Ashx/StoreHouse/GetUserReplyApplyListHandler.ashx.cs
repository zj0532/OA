...
{
    /// <summary>
    /// GetUserReplyApplyListHandler 的摘要说明
    /// </summary>
    [WebService(Namespace = "http://tempuri.org/")]
    [WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
    public class GetUserReplyApplyListHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            DataTable dt = new BLL.ApplyArticleBLL().GetList(15, page, "AADate desc", "AsID='1'").Tables[0];
