...
{
    /// <summary>
    /// HolidayHistoryExportHandler 的摘要说明
    /// </summary>
    [WebService(Namespace = "http://tempuri.org/")]
    [WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
    public class HolidayHistoryExportHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            DateTime MaxDate = Convert.ToDateTime(context.Request["EndDate"].Trim() == "" ? DateTime.Now.ToShortDateString() + " 23:59:59" : context.Request["EndDate"]);
            string HolidayClass = context.Request["HolidayClass"];
            ...
            try
            {
                dt = new BLL.AttendanceBLL().GetListByChineseName(strWhere).Tables[0];
                MemoryStream Ms = RenderToExcel(dt);
                string fileName = DateTime.Now.ToString("yyyyMMddHHmmss") + "查询请假历史记录导出表.XLS";
