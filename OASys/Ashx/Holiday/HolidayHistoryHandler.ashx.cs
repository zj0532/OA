...
{
    /// <summary>
    /// HolidayHistoryHandler 的摘要说明
    /// </summary>
    [WebService(Namespace = "http://tempuri.org/")]
    [WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
    public class HolidayHistoryHandler : IHttpHandler
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            dt = new BLL.AttendanceBLL().GetList(15, Page, "postdate desc", "postCause='请假' and stauts>10 ").Tables[0];
            if (dt.Rows.Count > 0)
            {
