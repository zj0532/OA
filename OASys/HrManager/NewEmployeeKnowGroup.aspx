...
<body style="overflow:hidden;" scroll="no">
    ...
    <table id="dg" title="新员工须知" style="width:1046px;height:460px"
           data-options="rownumbers:true,singleSelect:true,pagination:true,url:'../Ashx/User/GetBusinesslistHandler.ashx',method:'POST'">
        <thead>
            <tr >
                <th data-options="field:'title',width:300">标题</th>
                <th data-options="field:'usname',width:150">发布人</th>
