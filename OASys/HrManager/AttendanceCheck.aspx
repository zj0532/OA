                     ...
                     $.ajax({
                         ...
                         success: function (data) {
                             ...
                             $.each(data, function (commentIndex, comment) {
                                 if (comment['result'] == 0) {
                                     $.messager.alert("导出失败", "导出考勤表失败！", "error");
...
<body style="overflow:hidden;" scroll="no" onload="Show()">
    <form id="form1" runat="server">
      <table id="dg" title="项目组考勤记录查询" style="width:1046px;height:460px"
           data-options="rownumbers:true,singleSelect:true,pagination:true,url:'../ashx/Attendance/AttendanceCheckHandler.ashx',method:'POST'">
        <thead>
            <tr >
        ...
        <table>
            ...
            <tr>
                <td colspan="2" style="height:50px;text-align:right;">
                   ...
                   <input id="bthExportMonth" class="button white" type="button" value="导出总表" onclick="ExportExlTime()" />
