<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlanList.aspx.cs" Inherits="OASys.WorkPlan.PlanList" %>
...
<body onload="Show()">
    ...
    <table id="dg" title="作业计划列表" style="width:1046px;height:460px"
           data-options="rownumbers:true,singleSelect:true,pagination:true,url:'../ashx/plan/GetPlanListByUserAuthorityHandler.ashx',method:'POST'">
            <thead>
            <tr>
     ...
     <div id="dlgSearch" class="easyui-dialog" closed="true" title="搜索作业计划" style="width:500px;height:220px;padding:10px; padding-top:20px">
        <table>
            <tr>
                <td style="width:30px">
         ...
         function SearchResult() {
             $(function () {
                 ...
                 $.ajax({
                     ...
                     url: "../Ashx/Plan/SearchPlanHandler.ashx",
