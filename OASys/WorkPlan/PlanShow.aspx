<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PlanShow.aspx.cs" Inherits="OASys.WorkPlan.PlanShow" %>
 ...
 <div id="AddOPL" style="width:1046px;margin-right:20px;margin-bottom:20px;">
      ...
      <table style="border-bottom:1px solid #ccc;border-left:1px solid #ccc;border-right:1px solid #ccc; width:100%; height:100%;" >
                 <tr>
                     ...
                     <td>
                         <input  id="txtQs" readonly="true" class="textbox03" style="width:450px" type="text"  value="" />
                     </td>
                 </tr>
                 <tr>
                     <td style="width:200px"></td>
                     ...
                     <td>
                        <input  id="TrudeDate" class="easyui-datebox" style="width:456px" type="text"  value="" />
                     </td>
                 </tr>
                 ...
                 <tr>
                     ...
                     <td>
                        <textarea id="txtContent" runat="server" cols="20" rows="10" style="width:450px"></textarea>
                         <asp:HiddenField ID="hfwpiid" runat="server" />
                     </td>
                 </tr>
                 ...
                 <tr>
                     ...
                     <td>
                         <asp:FileUpload ID="FileUpload1" runat="server" CssClass="textbox03" Width="451px" />
                     </td>
                 </tr>
                  ...
                  <tr>
                     ...
                     <td>
                         <asp:Button ID="bthOK" CssClass="button white" runat="server" Text="添加回复" OnClick="bthOK_Click" />
       ...
       $(function () {
           ...
           $("#dg").datagrid({
               onClickRow: function (index, data)
               {
                   ...
                   $("#txtQs").val(row.Times);
                   $("#TrudeDate").datebox("setValue", new Date().getFullYear()+"-"+(new Date().getMonth()+1)+"-"+new Date().getDate());
                   $("#<%=hfwpiid.ClientID%>").val(row.WPIID);
