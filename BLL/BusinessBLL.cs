...
namespace BLL
{
    public  class BusinessBLL
    {
        ...
        private readonly DAL.BusinessDAL dal = new DAL.BusinessDAL();
        #region  BasicMethod
        /// <summary>
        /// 是否存在该记录
        /// </summary>
        ...
        /// 获得数据列表
        /// </summary>
        public List<MDL.BusinessMOD> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<MDL.BusinessMOD> DataTableToList(DataTable dt)
        {
            List<MDL.BusinessMOD> modelList = new List<MDL.BusinessMOD>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                MDL.BusinessMOD model;
