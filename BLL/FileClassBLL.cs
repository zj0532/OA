...
namespace BLL
{
    public  class FileClassBLL
    {
        private readonly DAL.FileClassDAL dal = new DAL.FileClassDAL();
        #region  BasicMethod
        /// <summary>
        /// 是否存在该记录
        /// </summary>
        ...
        /// 获得数据列表
        /// </summary>
        public List<MDL.FileClassMOD> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<MDL.FileClassMOD> DataTableToList(DataTable dt)
        {
            List<MDL.FileClassMOD> modelList = new List<MDL.FileClassMOD>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                MDL.FileClassMOD model;
