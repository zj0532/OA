...
namespace BLL
{
   public class MeetingSummaryBLL
    {
       private readonly DAL.MeetingSummaryDAL dal = new DAL.MeetingSummaryDAL();
       #region  BasicMethod
       /// <summary>
       /// 是否存在该记录
       /// </summary>
       ...
       /// 获得数据列表
       /// </summary>
       public List<MDL.MeetingSummaryMOD> GetModelList(string strWhere)
       {
       ...
       /// 获得数据列表
       /// </summary>
       public List<MDL.MeetingSummaryMOD> DataTableToList(DataTable dt)
       {
           List<MDL.MeetingSummaryMOD> modelList = new List<MDL.MeetingSummaryMOD>();
           int rowsCount = dt.Rows.Count;
           if (rowsCount > 0)
           {
               MDL.MeetingSummaryMOD model;
