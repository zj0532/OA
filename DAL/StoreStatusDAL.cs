...
namespace DAL
{
    public class StoreStatusDAL
    {
        ...
        public bool Exists(int StID)
        {
            ...
            strSql.Append("select count(1) from tbStoreStatus");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into tbStoreStatus(");
            strSql.Append("StName,Remark)");
            strSql.Append(" values (");
            strSql.Append("@StName,@Remark)");
            strSql.Append(";select @@IDENTITY");
            SqlParameter[] parameters = {
					new SqlParameter("@StName", SqlDbType.NVarChar,200),
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update tbStoreStatus set ");
        ...
        public bool Delete(int StID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from tbStoreStatus ");
            strSql.Append(" where StID=@StID");
            SqlParameter[] parameters = {
					new SqlParameter("@StID", SqlDbType.Int,4)
			};
        ...
        public MDL.StoreStatusMOD GetModel(int StID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select  top 1 StID,StName,Remark from tbStoreStatus ");
            strSql.Append(" where StID=@StID");
            SqlParameter[] parameters = {
					new SqlParameter("@StID", SqlDbType.Int,4)
			};
            ...
            MDL.StoreStatusMOD model = new MDL.StoreStatusMOD();
        ...
        /// 得到一个对象实体
        /// </summary>
        public MDL.StoreStatusMOD DataRowToModel(DataRow row)
        {
            MDL.StoreStatusMOD model = new MDL.StoreStatusMOD();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select StID,StName,Remark ");
            strSql.Append(" FROM tbStoreStatus ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetList(int Top, string strWhere, string filedOrder)
        {
            ...
            strSql.Append(" StID,StName,Remark ");
            strSql.Append(" FROM tbStoreStatus ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from tbStoreStatus T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string Order,string strWhere)
        {
            ...
            parameters[0].Value = "tbStoreStatus";
